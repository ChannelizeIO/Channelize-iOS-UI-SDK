Pod::Spec.new do |spec|
  ...
  spec.resource_bundle = { 'ChannelizeUI' => 'ChannelizeUI/ChannelizeUI/Sources/ChannelizeActionIcons.xcassets' }
  spec.resources = ['ChannelizeUI/ChannelizeUI/Sources/ChannelizeActionIcons.xcassets', 'ChannelizeUI/ChannelizeUI/Sources/ChannelizeUIIcons.xcassets']
  spec.ios.resource_bundle = { 'ChannelizeUI' => 'ChannelizeUI/ChannelizeUI/Sources/ChannelizeActionIcons.xcassets' }
