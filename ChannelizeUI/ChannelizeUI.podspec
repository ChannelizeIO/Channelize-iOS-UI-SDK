Pod::Spec.new do |spec|
  ...
  spec.resources = ['ChannelizeUI/ChannelizeUI/Sources/Image_Resources/**/*.{jpeg,png}', 'ChannelizeUI/ChannelizeUI/Sources/ChannelizeActionIcons.xcassets', 'ChannelizeUI/ChannelizeUI/Sources/ChannelizeUIIcons.xcassets']
