Pod::Spec.new do |spec|
  ...
  spec.resource_bundles = { "ChannelizeUI" => ['ChannelizeUI/ChannelizeUI/Sources/Image_Resources/ChannelizeActionIcons.xcassets','ChannelizeUI/ChannelizeUI/Sources/Image_Resources/ChannelizeUIIcons.xcassets'] }
