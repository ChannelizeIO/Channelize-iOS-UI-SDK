...
class NoMessageCollectionCell: UICollectionViewCell {
    ...
    private var noConversationImageView: UIImageView = {
        ...
        imageView.image = getImage("noMessages.png")
        return imageView
    }()
    ...
    private var noConversationLabel: UILabel = {
        ...
        label.text = "No messages. Be the first one to share messages, photos, videos, and much more."
        return label
    }()
