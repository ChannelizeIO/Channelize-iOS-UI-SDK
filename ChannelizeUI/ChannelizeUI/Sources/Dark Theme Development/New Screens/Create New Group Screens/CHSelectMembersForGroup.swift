...
class CHSelectMembersForGroup: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = CHAppConstant.themeStyle == .dark ? CHDarkThemeColors.instance.plainTableBackGroundColor : CHLightThemeColors.instance.plainTableBackGroundColor
        
        let nextButton = UIBarButtonItem(title: "Next", style: .plain, target: self, action: #selector(nextButtonPressed(sender:)))
    ...
    @objc private func nextButtonPressed(sender: UIBarButtonItem) {
        let controller = CHNewGroupViewController()
