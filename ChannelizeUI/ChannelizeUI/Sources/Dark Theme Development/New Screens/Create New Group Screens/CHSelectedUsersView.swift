    ...
    func removeItemFromCollectionView(itemId: String) {
        ...
        if self.selectedUsers.count == 0 {
            ...
            if self.viewWithTag(10001) == nil {
                self.addBottomBorder(with: CHAppConstant.themeStyle == .dark ? CHDarkThemeColors.instance.seperatorColor : CHLightThemeColors.instance.seperatorColor, andWidth: 0.5)
            }
        }
    }
